...
public class Estorage {
	...
	public Estorage(String id, String name, double price, String image, String retailer,double discount, HashMap<String, String> accessories, int quantity, String rebate, String sale)
